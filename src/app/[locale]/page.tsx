...
export default function Home({
  ...
  React.useEffect(() => {
    ...
    const typedDetail = new Typed(typedDetailRef.current, {
      strings: ["TO SVG PATH.", "TO YOUR WEBSITE.", "TO GIF OR VIDEO."],
      typeSpeed: 10,
      backSpeed: 30,
      shuffle: true,
      loop: true,
    ...
    const spherePathEls = (
      animateRef.current as unknown as Document
        ...
        for (var i = 0; i < pathLength; i++) {
          aimations.push(
            anime({
              ...
              stroke: {
                value: ["rgba(107, 33, 168, 0)", "rgba(200, 60, 200, 0)"],
                duration: 1000,
              },
              translateX: [2, -4],
              translateY: [2, -4],
    ...
    <>
      ...
      <div className="flex flex-col w-screen h-screen bg-transparent">
        ...
        <div className="flex-grow flex flex-col items-center justify-center">
          ...
          <div className="h-16">
            <span
              className="text-4xl	text-purple-950 border-4 p-3"
              ref={typedDetailRef}
            />
          </div>
      ...
      {/* generate */}
      <div className="flex flex-col w-screen h-screen dark:bg-black"></div>
    </>
  );
}
